...
AND wgec.EVENT_DT > '01/04/2019' 
) WITH DATA WITH replace ON commit PRESERVE ROWS ;

DECLARE GLOBAL TEMPORARY TABLE GC2_Q23 AS (
SELECT saa.* 
...
SELECT * FROM SESSION.GC2_Q23 ORDER BY ALF_PE

-- DROP TABLE FOR ALTERATIONS 
DROP TABLE sailw1317v.SS_GC2_Q23

--CREATE PERMINENT TABLE
CREATE TABLE sailw1317v.SS_GC2_Q23
(
...
INSERT INTO  sailw1317v.SS_GC2_Q23
SELECT TABLE_ID 
,ALF_PE         
,WOB
...
, SPIROMETRY_FLAG 
, FENO_FLAG 
FROM SESSION.GC2_Q23

--SELECT NEW TABLE FOR CSV EXTRACTION 
SELECT * FROM sailw1317v.SS_GC2_Q23
...
DECLARE GLOBAL TEMPORARY TABLE GC2_Q24 AS (
SELECT saa.*
...
SELECT * FROM SESSION.GC2_Q24
ORDER BY ALF_PE

-- DROP TABLE FOR ALTERATIONS 
DROP TABLE sailw1317v.SS_GC2_Q24

--CREATE PERMINENT TABLE
CREATE TABLE sailw1317v.SS_GC2_Q24
(
TABLE_ID        VARCHAR(100)
,ALF_PE         BIGINT
,WOB            DATE
...
INSERT INTO  sailw1317v.SS_GC2_Q24
SELECT TABLE_ID 
,ALF_PE  
,WOB
,AGE_AT_END_OF_FOLLOW_UP  
...
FROM SESSION.GC2_Q24

--SELECT NEW TABLE FOR CSV EXTRACTION 
SELECT * FROM sailw1317v.SS_GC2_Q24
...
INNER JOIN sailw1317v.SS_ASTHMA_CHILD_COMORBIDITY SSA ON wgec.ALF_PE = SSA.ALF_PE
WHERE wgec.EVENT_CD = aac.EVENT_CD 
AND EVENT_CAT = 'FENO' AND wgec.EVENT_DT > '2019-11-01'
) WITH DATA WITH replace ON commit PRESERVE ROWS ;

DECLARE GLOBAL TEMPORARY TABLE GC2_Q25 AS (
SELECT saa.* 
, CASE WHEN saa.ALF_PE IN (SELECT ALF_PE FROM SESSION.Cohort_Q23_Events WHERE EVENT_CAT = 'FENO' ) THEN 1 ELSE 0 END AS FENO_FLAG
FROM sailw1317v.SS_ASTHMA_CHILD_COMORBIDITY saa
) WITH DATA WITH replace ON commit PRESERVE ROWS ;

SELECT * FROM SESSION.GC2_Q25
ORDER BY ALF_PE

-- DROP TABLE FOR ALTERATIONS 
DROP TABLE sailw1317v.SS_GC2_Q25

--CREATE PERMINENT TABLE
CREATE TABLE sailw1317v.SS_GC2_Q25
(
TABLE_ID        VARCHAR(100)
,ALF_PE         BIGINT
,WOB            DATE
...
INSERT INTO  sailw1317v.SS_GC2_Q25
SELECT TABLE_ID 
,ALF_PE  
,WOB
,AGE_AT_END_OF_FOLLOW_UP  
...
,LOCALHEALTHBOARDNAME 
, FENO_FLAG
FROM SESSION.GC2_Q25

--SELECT NEW TABLE FOR CSV EXTRACTION 
SELECT * FROM sailw1317v.SS_GC2_Q25
...
DECLARE GLOBAL TEMPORARY TABLE GC2_Q26 AS (
SELECT saa.* 
...
-- DROP TABLE FOR ALTERATIONS 
DROP TABLE sailw1317v.SS_GC2_Q26

--CREATE PERMINENT TABLE
CREATE TABLE sailw1317v.SS_GC2_Q26
(
TABLE_ID        VARCHAR(100)
,ALF_PE         BIGINT
,WOB            DATE
...
INSERT INTO  sailw1317v.SS_GC2_Q26
SELECT TABLE_ID 
,ALF_PE  
,WOB
,AGE_AT_END_OF_FOLLOW_UP  
...
, REVERSIBILITY_FLAG
FROM SESSION.GC2_Q26

--SELECT NEW TABLE FOR CSV EXTRACTION 
SELECT * FROM sailw1317v.SS_GC2_Q26
...
DECLARE GLOBAL TEMPORARY TABLE GC2_Q34 AS (
SELECT saa.* 
...
SELECT * FROM SESSION.GC2_Q34
ORDER BY ALF_PE

-- DROP TABLE FOR ALTERATIONS 
DROP TABLE sailw1317v.SS_GC2_Q34

--CREATE PERMINENT TABLE
CREATE TABLE sailw1317v.SS_GC2_Q34
(
ALF_PE         BIGINT
,WOB            DATE
,AGE_AT_END_OF_FOLLOW_UP  BIGINT
...
INSERT INTO  sailw1317v.SS_GC2_Q34
SELECT ALF_PE      
,WOB
,AGE_AT_END_OF_FOLLOW_UP  
,FIRST_EVENT
...
FROM SESSION.GC2_Q34

--SELECT NEW TABLE FOR CSV EXTRACTION 
SELECT * FROM sailw1317v.SS_GC2_Q34
...
DECLARE GLOBAL TEMPORARY TABLE GC2_Q35 AS(
SELECT q.* FROM SESSION.Cohort_Q35_Events q
INNER JOIN sailw1317v.SS_ASTHMA_CHILD_COMORBIDITY SSA ON q.ALF_PE = SSA.ALF_PE
...
DECLARE GLOBAL TEMPORARY TABLE GC2_Q36 AS (
SELECT saa.* 
...
SELECT * FROM SESSION.GC2_Q36
ORDER BY ALF_PE

-- DROP TABLE FOR ALTERATIONS 
DROP TABLE sailw1317v.SS_GC2_Q36

--CREATE PERMINENT TABLE
CREATE TABLE sailw1317v.SS_GC2_Q36
(
TABLE_ID        VARCHAR(100)
,ALF_PE         BIGINT
,WOB            DATE
...
INSERT INTO  sailw1317v.SS_GC2_Q36
SELECT TABLE_ID 
,ALF_PE  
,WOB
,AGE_AT_END_OF_FOLLOW_UP  
...
FROM SESSION.GC2_Q36

--SELECT NEW TABLE FOR CSV EXTRACTION 
SELECT * FROM sailw1317v.SS_GC2_Q36
...
DECLARE GLOBAL TEMPORARY TABLE GC2_Q37 AS ( 
...
-- DROP TABLE FOR ALTERATIONS 
DROP TABLE sailw1317v.SS_GC2_Q37

--CREATE PERMINENT TABLE
CREATE TABLE sailw1317v.SS_GC2_Q37
(
ALF_PE VARCHAR(100), 
EVENT_CD VARCHAR(100), 
TERM VARCHAR(100), 
...
INSERT INTO  sailw1317v.SS_GC2_Q37
SELECT 
ALF_PE  
,EVENT_CD  
,TERM 
,CATEGORY 
,EVENT_DT 
FROM SESSION.GC2_Q37

--SELECT NEW TABLE FOR CSV EXTRACTION 
SELECT * FROM sailw1317v.SS_GC2_Q37
...
DECLARE GLOBAL TEMPORARY TABLE GC2_Q42 AS (
SELECT saa.* 
, CASE WHEN saa.ALF_PE IN (SELECT DISTINCT ALF_PE FROM SESSION.Cohort_Q42_Events) THEN 1 ELSE 0 END AS PAAP_LAST_YEAR
FROM sailw1317v.SS_ASTHMA_CHILD_COMORBIDITY saa
) WITH DATA WITH replace ON commit PRESERVE ROWS ;

SELECT * FROM SESSION.GC2_Q42
ORDER BY ALF_PE

-- DROP TABLE FOR ALTERATIONS 
DROP TABLE sailw1317v.SS_GC2_Q42

--CREATE PERMINENT TABLE
CREATE TABLE sailw1317v.SS_GC2_Q42
(
TABLE_ID        VARCHAR(100)
,ALF_PE         BIGINT
,WOB            DATE
...
INSERT INTO  sailw1317v.SS_GC2_Q42
SELECT TABLE_ID 
,ALF_PE  
,WOB
,AGE_AT_END_OF_FOLLOW_UP  
...
,LOCALHEALTHBOARDNAME 
, PAAP_LAST_YEAR
FROM SESSION.GC2_Q42

--SELECT NEW TABLE FOR CSV EXTRACTION 
SELECT * FROM sailw1317v.SS_GC2_Q42
...
DECLARE GLOBAL TEMPORARY TABLE GC2_Q43 AS (
SELECT saa.* 
, CASE WHEN saa.ALF_PE IN (SELECT DISTINCT ALF_PE FROM SESSION.Cohort_Q43_Events) THEN 1 ELSE 0 END AS RCP_LAST_YEAR
FROM sailw1317v.SS_ASTHMA_CHILD_COMORBIDITY saa
) WITH DATA WITH replace ON commit PRESERVE ROWS ;

SELECT * FROM SESSION.GC2_Q43
ORDER BY ALF_PE


-- DROP TABLE FOR ALTERATIONS 
DROP TABLE sailw1317v.SS_GC2_Q43

--CREATE PERMINENT TABLE
CREATE TABLE sailw1317v.SS_GC2_Q43
(
TABLE_ID        VARCHAR(100)
,ALF_PE         BIGINT
,WOB            DATE
...
INSERT INTO  sailw1317v.SS_GC2_Q43
SELECT TABLE_ID 
,ALF_PE  
,WOB
,AGE_AT_END_OF_FOLLOW_UP  
...
,LOCALHEALTHBOARDNAME 
, RCP_LAST_YEAR
FROM SESSION.GC2_Q43

--SELECT NEW TABLE FOR CSV EXTRACTION 
SELECT * FROM sailw1317v.SS_GC2_Q43
...
DECLARE GLOBAL TEMPORARY TABLE GC2_Q46 AS (
SELECT saa.* 
...
SELECT * FROM SESSION.GC2_Q46
ORDER BY ALF_PE

-- DROP TABLE FOR ALTERATIONS 
DROP TABLE sailw1317v.SS_GC2_Q46

--CREATE PERMINENT TABLE
CREATE TABLE sailw1317v.SS_GC2_Q46
(
TABLE_ID        VARCHAR(100)
,ALF_PE         BIGINT
,WOB            DATE
...
INSERT INTO  sailw1317v.SS_GC2_Q46
SELECT TABLE_ID 
,ALF_PE  
,WOB
,AGE_AT_END_OF_FOLLOW_UP  
...
FROM SESSION.GC2_Q46

--SELECT NEW TABLE FOR CSV EXTRACTION 
SELECT * FROM sailw1317v.SS_GC2_Q46
...
DECLARE GLOBAL TEMPORARY TABLE GC2_Q47 AS (
SELECT saa.* 
, CASE WHEN saa.ALF_PE IN (SELECT DISTINCT ALF_PE FROM SESSION.Cohort_Q47_Events) THEN 1 ELSE 0 END AS FLU_VAX_FLAG
FROM sailw1317v.SS_ASTHMA_CHILD_COMORBIDITY saa
) WITH DATA WITH replace ON commit PRESERVE ROWS ;

SELECT COUNT(DISTINCT ALF_PE) FROM SESSION.GC2_Q47 WHERE FLU_VAX_FLAG = '1' --54,562

SELECT * FROM SESSION.GC2_Q47
ORDER BY ALF_PE

-- DROP TABLE FOR ALTERATIONS 
DROP TABLE sailw1317v.SS_GC2_Q47

--CREATE PERMINENT TABLE
CREATE TABLE sailw1317v.SS_GC2_Q47
(
TABLE_ID        VARCHAR(100)
,ALF_PE         BIGINT
,WOB            DATE
...
INSERT INTO  sailw1317v.SS_GC2_Q47
SELECT TABLE_ID 
,ALF_PE  
,WOB
,AGE_AT_END_OF_FOLLOW_UP  
...
,LOCALHEALTHBOARDNAME 
, FLU_VAX_FLAG
FROM SESSION.GC2_Q47

--SELECT NEW TABLE FOR CSV EXTRACTION 
SELECT * FROM sailw1317v.SS_GC2_Q47
...
SELECT * FROM SESSION.GC2_Q48 WHERE SMOKING_CESSATION_FLAG = 1
...
DECLARE GLOBAL TEMPORARY TABLE GC2_Q492 AS (
...
-- DROP TABLE TO ADD CHANGES
DROP TABLE sailw1317v.SS_GC2_Q49_ALL

CREATE TABLE sailw1317v.SS_GC2_Q49_ALL(
ALF_PE         BIGINT
,WOB            DATE
,GNDR_CD        INT
,EVENT_CD        VARCHAR(100)
...
INSERT INTO  sailw1317v.SS_GC2_Q49_ALL
SELECT ALF_PE         
,WOB            
,GNDR_CD        
,EVENT_CD  
...
,LOCAL_NUM_PE        
, TERM 
FROM SESSION.GC2_Q492

--SELECT NEW TABLE FOR CSV EXTRACTION 
SELECT * FROM sailw1317v.SS_GC2_Q49_ALL 
ORDER BY ALF_PE