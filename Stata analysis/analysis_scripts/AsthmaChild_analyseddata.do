...
capture log close
log using analysis_logs/AsthmaChild_analyseddata, text replace
...
export delimited outputs/AnalysedPrimaryCareAudit_AsthmaChild, replace

log close



log using outputs/ca_labels, text replace
