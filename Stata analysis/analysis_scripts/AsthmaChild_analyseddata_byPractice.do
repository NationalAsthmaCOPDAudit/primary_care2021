...
capture log close
log using analysis_logs/AsthmaChild_analyseddata_byPractice, text replace
...
export delimited outputs/practice_files/AnalysedPrimaryCareAudit_AsthmaChild_practice, replace
